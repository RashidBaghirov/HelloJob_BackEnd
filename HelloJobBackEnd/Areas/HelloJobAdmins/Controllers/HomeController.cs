...
namespace HelloJobBackEnd.Areas.HelloJobAdmins.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public HomeController(HelloJobDbContext context, IVacansService vacansService, ICvPageService cvPageService, IBusinessTitleService businessTitleService, ICompanyService companyService)
        {
            _context = context;
