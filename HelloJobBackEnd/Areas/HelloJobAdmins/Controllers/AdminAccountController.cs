...
namespace HelloJobBackEnd.Areas.HelloJobAdmins.Controllers
{
    ...
    public class AdminAccountController : Controller
    {
        ...
        public AdminAccountController(UserManager<User> usermanager, SignInManager<User> signInManager, RoleManager<IdentityRole> roleManager, HelloJobDbContext context)
        {
